...
## [rajsingh.info](http://rajsingh.info) and serverless [rajsingh.info/personal-site](https://rajsingh.info/personal-site/)

My personal website. Easily modifiable, and built using modern javascript with Node.js, React, Express, React-Router, Hot Module Reloading, Webpack and many other technologies.

The master branch of this repository contains a simplified version of my website intended for serverless hosting on github pages. To view the source for the version hosted at [rajsingh.info](https://rajsingh.info), checkout the [server](https://github.com/rajsinghtech/personal-site/tree/server) branch.

## A note on adapting this repository to your own personal website

Many people have contacted me about adapting this website. I have tried to make things as simple as possible. There are still bugs. I am sorry. If you find a bug, please email me (help@rajsingh.info) or submit an issue or a pull request.
...
1. To download the repository and install dependencies, run the following commands:
    ...
    ```bash
    git clone git://github.com/mlSingh/personal-site.git
    cd personal-site
    nvm install
    npm install
    ```
...
5. You've finished modifying >95% of the pages. Search through the rest of the files for references to `Raj` or `Singh` and change values to your name.
...
(e.g. [https://rajsingh.info/personal-site/](https://rajsingh.info/personal-site/)), you should modify `BASE_PATH` in your `.env` and `sample.env` files and restart the express server. Note that you will now have to navigate to `localhost:[port]/[BASE_PATH]` when developing.
...
Please feel free to reach out to me by filing an issue or at [help@rajsingh.info](mailto:help@rajsingh.info) for help configuring your project.

## Contributors

* [@mlSingh](https://github.com/mlSingh)
...
[MIT](https://github.com/rajsinghtech/personal-site/blob/master/LICENSE)
